...
class AAPM(Dataset):
    ...
    def __getitem__(self,index):
        ...
        dataCT=scio.loadmat(self.data_names[index])['label']
...
def create_dataloader(configs, evaluation=False, sort=True):
  ...
  # else:
  train_dataset = AAPM(root= "/opt/data/private/zhangzhx2/3D-SDE/AAPM/train1-2/")
  val_dataset = AAPM(root= "/opt/data/private/zhangzhx2/3D-SDE/AAPM/train1-2/")
